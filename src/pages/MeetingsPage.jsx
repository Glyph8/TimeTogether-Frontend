...
function MeetingsPage() {
    ...
    // axios.get('group/groupID/when/{groupId}').then((whenDataResponse) => {//그룹 목록 클릭 시 해당 그룹ID 전송
    //
    //     console.log(whenDataResponse.data);
    // }).catch(
    //     (err) => {
    //         console.log(`MeetingPage When GET요청 에러 ${err}`)
    //     }
    // )
